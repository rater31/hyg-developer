      ...
      <div className='container-fluid text-light  mt-5 justify-content-center'>
         ...
         <div className="row text-center align-items-center">
            <div className="col-5 ms-3  mt-5">
               ...
               <Section className='mt-5'>Convertimos sus diseños en páginas web que se vean y funcionen de manera excelente El primer paso es diseñar la página web. Esto implica decidir el contenido, la estructura  y el estilo de la página..</Section>
            </div>
         ...
         <div className='row text-center align-items-center'>
            ...
            <div className='col-4 ms-3 mt-5'>
               ...
               <Section className='mt-5'>Una vez que el diseño de la página web está aprobado, se procede al desarrollo de la página web. Esto implica codificar la página web utilizando un lenguaje de programación</Section>
            </div>
         </div>
         <div className='row text-center align-items-center'>
            <div className='col-6 ms-3 mt-5'>
               ...
               <div className="row justify-content-center">
                  <div className="line w-25"></div>
                  <Section className='mt-5'>Una vez que la página web está desarrollada, se debe probar para asegurarse de que funciona correctamente. Esto implica probar la página web en diferentes navegadores, dispositivos y resoluciones de pantalla.</Section>
               </div>
            </div>
            <div className='col-5 ms-3 mt-5'>
